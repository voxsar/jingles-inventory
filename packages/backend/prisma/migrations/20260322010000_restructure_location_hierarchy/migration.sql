...
-- Drop old storage_boxes_shelf_id_fkey constraint before re-adding with new policy
ALTER TABLE "storage_boxes" DROP CONSTRAINT IF EXISTS "storage_boxes_shelf_id_fkey";
