...
vi.mock('@prisma/client', () => {
  function MockPrismaClient(this: any) {
    ...
    this.unitOfMeasure = { findUnique: vi.fn(), findMany: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn(), count: vi.fn() };
    ...
    this.statusOption = { findUnique: vi.fn(), findFirst: vi.fn(), findMany: vi.fn(), create: vi.fn(), update: vi.fn(), delete: vi.fn(), count: vi.fn() };
